    ...
    public partial class Expander : UserControl
    {
        ...
        public Control Header
        {
            ...
            set
            {
                ...
                this.header = value;
                if (this.header != null) this.header.Dock = DockStyle.Top;
                this.Controls.Add(this.header);
                if (this.header != null) this.Controls.SetChildIndex(this.header, this.Controls.Count > 1 ? 1 : 0);
            }
        }
        ...
        public Control Content
        {
            ...
            set
            {
                ...
                this.content = value;
                if (this.header != null) this.Size = new Size(this.Width, this.header.Height + this.content.Height);
                if (this.header != null) this.content.Top = this.header.Height;

                this.Controls.Add(this.content);
                if (this.content != null) this.Controls.SetChildIndex(this.content, 0);
            }
        }
